...
// src/test/application/select-portal-controll-by-partner.spec.ts
describe("select portall-controlls", () => {
  ...
  it("shoud be able selects all portalcontrolls by partner", async () => {
    ...
    globalExpect(result).toEqual(
      globalExpect.arrayContaining([portalcontroll1, portalcontroll2])
    );
    globalExpect(result[0].partnerId).toEqual(partner);
  });
});
