...
// src/test/application/update-contract.spec.ts
describe("create a new contract", () => {
  ...
  it("should be possible to update the contract", async () => {
    ...
    if (result) {
      globalExpect(result.city).toBe("Nova Cidade");
    }
  });
  ...
  it("should throw an error when trying to update a contract without an id", async () => {
    ...
    ).rejects.toThrowError("N\xE3o foi encontrado o contrato para atualizar!");
  });
});
