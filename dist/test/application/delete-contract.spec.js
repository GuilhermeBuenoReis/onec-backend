...
// src/test/application/delete-contract.spec.ts
describe("delete a contract", () => {
  ...
  it("should be possible to delete the contract", async () => {
    const contractData = {
      ...
      year: "2025",
      matter: "Mat\xE9ria Exemplo",
      forecast: "Previs\xE3o Exemplo",
      contractTotal: "10000",
      percentage: 15,
      signedContract: (/* @__PURE__ */ new Date()).toISOString(),
      averageGuide: 500,
    ...
    const found2 = contracts.find((c) => c.id === "1");
  ...
  it("should throw an error when trying to delete a contract without an id", async () => {
    await globalExpect(repository.delete("")).rejects.toThrowError(
      "N\xE3o foi encontrado o contrato para ser deletado!"
    );
  });
});
