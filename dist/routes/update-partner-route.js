...
var update_partner_route_exports = {};
__export(update_partner_route_exports, {
  updatePartnerRoute: () => updatePartnerRoute
});
module.exports = __toCommonJS(update_partner_route_exports);
...
// src/routes/update-partner-route.ts
var updatePartnerRoute = async (app) => {
  app.put(
    "/partners/:id",
    {
      ...
      schema: {
        ...
        body: import_zod2.z.object({
          ...
          cpfOrCnpj: import_zod2.z.string().optional(),
          city: import_zod2.z.string().nullable().optional(),
          state: import_zod2.z.string().nullable().optional(),
          commission: import_zod2.z.number().nullable().optional(),
          portal: import_zod2.z.string().nullable().optional(),
          channelHead: import_zod2.z.string().nullable().optional(),
          regional: import_zod2.z.string().nullable().optional(),
          coordinator: import_zod2.z.string().nullable().optional(),
          agent: import_zod2.z.string().nullable().optional(),
          indicator: import_zod2.z.string().nullable().optional(),
          contract: import_zod2.z.string().nullable().optional(),
