...
var delete_portal_controll_route_exports = {};
__export(delete_portal_controll_route_exports, {
  deletePortalControllRoute: () => deletePortalControllRoute
});
module.exports = __toCommonJS(delete_portal_controll_route_exports);
...
// src/routes/delete-portal-controll-route.ts
var deletePortalControllRoute = async (app) => {
  app.delete(
    "/portalcontrolls/:id",
    {
