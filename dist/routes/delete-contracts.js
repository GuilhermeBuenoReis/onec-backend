...
var delete_contracts_exports = {};
__export(delete_contracts_exports, {
  deleteContractRoute: () => deleteContractRoute
});
module.exports = __toCommonJS(delete_contracts_exports);
...
// src/routes/delete-contracts.ts
var deleteContractRoute = async (app) => {
  app.delete(
    "/contract/:id",
    {
