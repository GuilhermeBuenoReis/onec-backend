...
var update_contract_exports = {};
__export(update_contract_exports, {
  updateContractRoute: () => updateContractRoute
});
module.exports = __toCommonJS(update_contract_exports);
...
// src/routes/update-contract.ts
var updateContractRoute = async (app) => {
  app.put(
    "/contract/:id",
    {
      ...
      schema: {
        ...
        body: import_zod2.z.object({
          city: import_zod2.z.string().nullable().optional(),
          client: import_zod2.z.string().optional(),
          state: import_zod2.z.string().nullable().optional(),
          cnpj: import_zod2.z.string().nullable().optional(),
          sindic: import_zod2.z.string().nullable().optional(),
          year: import_zod2.z.string().nullable().optional(),
          matter: import_zod2.z.string().nullable().optional(),
          forecast: import_zod2.z.string().nullable().optional(),
          contractTotal: import_zod2.z.string().nullable().optional(),
          percentage: import_zod2.z.number().nullable().optional(),
          signedContract: import_zod2.z.string().nullable().optional(),
          status: import_zod2.z.string().nullable().optional(),
          averageGuide: import_zod2.z.number().nullable().optional(),
          partner: import_zod2.z.string().nullable().optional(),
          partnerCommission: import_zod2.z.number().nullable().optional(),
          counter: import_zod2.z.string().nullable().optional(),
          email: import_zod2.z.string().nullable().optional()
        }),
        response: {
