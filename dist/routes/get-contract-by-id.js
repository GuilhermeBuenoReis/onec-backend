...
var get_contract_by_id_exports = {};
__export(get_contract_by_id_exports, {
  getContractByIdRoute: () => getContractByIdRoute
});
module.exports = __toCommonJS(get_contract_by_id_exports);
...
// src/routes/get-contract-by-id.ts
var getContractByIdRoute = async (app) => {
  app.get(
    "/contract/:id",
    {
      schema: {
        ...
        response: {
          200: import_zod2.z.object({
            ...
            sindic: import_zod2.z.string().nullable(),
            year: import_zod2.z.string().nullable(),
            matter: import_zod2.z.string().nullable(),
            forecast: import_zod2.z.string().nullable(),
            contractTotal: import_zod2.z.string().nullable(),
            percentage: import_zod2.z.number().nullable(),
            signedContract: import_zod2.z.string().nullable(),
            status: import_zod2.z.string().nullable(),
            averageGuide: import_zod2.z.number().nullable(),
            partner: import_zod2.z.string().nullable(),
            partnerCommission: import_zod2.z.number().nullable(),
            counter: import_zod2.z.string().nullable(),
