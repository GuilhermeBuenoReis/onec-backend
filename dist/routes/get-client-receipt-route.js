...
var get_client_receipt_route_exports = {};
__export(get_client_receipt_route_exports, {
  getClientReceiptRoute: () => getClientReceiptRoute
});
module.exports = __toCommonJS(get_client_receipt_route_exports);
...
// src/routes/get-client-receipt-route.ts
var getClientReceiptRoute = async (app) => {
  app.get(
    "/client-receipt",
    {
