...
var get_pendings_exports = {};
__export(get_pendings_exports, {
  getPendingsRoute: () => getPendingsRoute
});
module.exports = __toCommonJS(get_pendings_exports);
...
// src/routes/get-pendings.ts
var getPendingsRoute = async (app) => {
  app.get(
    "/pendings",
    {
