...
var delete_pending_exports = {};
__export(delete_pending_exports, {
  deletePendingRoute: () => deletePendingRoute
});
module.exports = __toCommonJS(delete_pending_exports);
...
// src/routes/delete-pending.ts
var deletePendingRoute = async (app) => {
  app.delete(
    "/pendings/:id",
    {
