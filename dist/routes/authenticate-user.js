...
var authenticate_user_exports = {};
__export(authenticate_user_exports, {
  authenticateUserRoute: () => authenticateUserRoute
});
module.exports = __toCommonJS(authenticate_user_exports);
...
var authenticateUserRoute = async (app) => {
  app.post(
    "/login",
    {
      schema: {
