...
var get_patners_route_exports = {};
__export(get_patners_route_exports, {
  getPartnersRoute: () => getPartnersRoute
});
module.exports = __toCommonJS(get_patners_route_exports);
...
// src/routes/get-patners-route.ts
var getPartnersRoute = async (app) => {
  app.get(
    "/partners",
    {
      schema: {
