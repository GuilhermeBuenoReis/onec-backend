...
var get_contracts_exports = {};
__export(get_contracts_exports, {
  getContractRoute: () => getContractRoute
});
module.exports = __toCommonJS(get_contracts_exports);
...
// src/routes/get-contracts.ts
var getContractRoute = async (app) => {
  app.get(
    "/contract",
    {
