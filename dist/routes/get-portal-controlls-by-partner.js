...
var get_portal_controlls_by_partner_exports = {};
__export(get_portal_controlls_by_partner_exports, {
  getPortalControllsBySelectParternRoute: () => getPortalControllsBySelectParternRoute
});
module.exports = __toCommonJS(get_portal_controlls_by_partner_exports);
...
var getPortalControllsBySelectParternRoute = async (app) => {
  app.get(
    "/portal/portalcontrolls",
    {
      schema: {
        ...
        querystring: import_zod2.z.object({
          partnerId: import_zod2.z.string().min(1, "partnerId \xE9 obrigat\xF3rio")
        }),
        response: {
