...
var delete_client_receipt_route_exports = {};
__export(delete_client_receipt_route_exports, {
  deleteClientReceiptRoute: () => deleteClientReceiptRoute
});
module.exports = __toCommonJS(delete_client_receipt_route_exports);
...
// src/routes/delete-client-receipt-route.ts
var deleteClientReceiptRoute = async (app) => {
  app.delete(
    "/client-receipt/:id",
    {
