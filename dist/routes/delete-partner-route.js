...
var delete_partner_route_exports = {};
__export(delete_partner_route_exports, {
  deletePartnerRoute: () => deletePartnerRoute
});
module.exports = __toCommonJS(delete_partner_route_exports);
...
// src/routes/delete-partner-route.ts
var deletePartnerRoute = async (app) => {
  app.delete(
    "/partners/:id",
    {
