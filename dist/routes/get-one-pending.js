...
var get_one_pending_exports = {};
__export(get_one_pending_exports, {
  getOnePendingRoute: () => getOnePendingRoute
});
module.exports = __toCommonJS(get_one_pending_exports);
...
// src/routes/get-one-pending.ts
var getOnePendingRoute = async (app) => {
  app.get(
    "/pending/:id",
    {
      schema: {
        ...
        response: {
          200: import_zod2.z.object({
            ...
            callReason: import_zod2.z.string().nullable(),
            status: import_zod2.z.enum(["Aberto", "Encaminhado", "Pendente", "Conclu\xEDdo"]).nullable(),
            priority: import_zod2.z.string().nullable(),
            ...
            updatedAt: import_zod2.z.date().optional()
          }),
