...
var create_new_pending_route_exports = {};
__export(create_new_pending_route_exports, {
  createPendingRoute: () => createPendingRoute
});
module.exports = __toCommonJS(create_new_pending_route_exports);
...
// src/routes/create-new-pending-route.ts
var createPendingRoute = async (app) => {
  app.post(
    "/pendings",
    {
