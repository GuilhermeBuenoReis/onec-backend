...
var get_credentials_and_clients_exports = {};
__export(get_credentials_and_clients_exports, {
  getCredentialClientRoute: () => getCredentialClientRoute
});
module.exports = __toCommonJS(get_credentials_and_clients_exports);
...
var DrizzleCredentialClientRepository = class {
  async selectCredentialsAndClients() {
    const newId = (0, import_cuid22.createId)().toString();
...
// src/routes/get-credentials-and-clients.ts
var getCredentialClientRoute = async (app) => {
  app.get(
    "/credential-client",
    {
        ...
        response: {
          200: import_zod2.z.array(
            import_zod2.z.object({
              ...
              credentials: import_zod2.z.object({
                id: import_zod2.z.string(),
              ...
              clients: import_zod2.z.object({
                id: import_zod2.z.string(),
                enterprise: import_zod2.z.string(),
                competenceMonth: import_zod2.z.string(),
                cnpj: import_zod2.z.string(),
                contestation: import_zod2.z.string(),
                returned: import_zod2.z.string()
              })
            })
          ),
