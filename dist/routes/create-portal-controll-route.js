...
var create_portal_controll_route_exports = {};
__export(create_portal_controll_route_exports, {
  createPortalControllRoute: () => createPortalControllRoute
});
module.exports = __toCommonJS(create_portal_controll_route_exports);
...
// src/routes/create-portal-controll-route.ts
var createPortalControllRoute = async (app) => {
  app.post(
    "/portalcontrolls",
    {
      ...
      schema: {
        ...
        response: {
          201: import_zod2.z.object({ id: import_zod2.z.string() })
        }
      }
    },
    async (request, reply) => {
