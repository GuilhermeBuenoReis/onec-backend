...
var update_negotiation_exports = {};
__export(update_negotiation_exports, {
  updateNegotiationRoute: () => updateNegotiationRoute
});
module.exports = __toCommonJS(update_negotiation_exports);
...
// src/routes/update-negotiation.ts
var updateNegotiationRoute = async (app) => {
  app.put(
    "/negotiation/:id",
    {
      ...
      schema: {
        ...
        body: import_zod2.z.object({
          ...
          user: import_zod2.z.string().optional(),
          tags: import_zod2.z.string().optional(),
          step: import_zod2.z.string().optional(),
          status: import_zod2.z.string().optional(),
          value: import_zod2.z.number().optional(),
          startsDate: import_zod2.z.string().nullable().optional(),
          partnerId: import_zod2.z.string().nullable().optional(),
          observation: import_zod2.z.string().nullable().optional(),
