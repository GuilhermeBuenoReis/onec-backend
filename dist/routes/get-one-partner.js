...
var get_one_partner_exports = {};
__export(get_one_partner_exports, {
  getOnePartnerRoute: () => getOnePartnerRoute
});
module.exports = __toCommonJS(get_one_partner_exports);
...
// src/routes/get-one-partner.ts
var getOnePartnerRoute = async (app) => {
  app.get(
    "/partners/:id",
    {
      schema: {
