...
var create_client_route_exports = {};
__export(create_client_route_exports, {
  createClientRoute: () => createClientRoute
});
module.exports = __toCommonJS(create_client_route_exports);
...
// src/routes/create-client-route.ts
var createClientRoute = async (app) => {
  app.post(
    "/client",
    {
