...
var delete_credentials_exports = {};
__export(delete_credentials_exports, {
  deleteCredentialRoute: () => deleteCredentialRoute
});
module.exports = __toCommonJS(delete_credentials_exports);
...
// src/routes/delete-credentials.ts
var deleteCredentialRoute = async (app) => {
  app.delete(
    "/credential/:id",
    {
