...
var delete_negotiation_exports = {};
__export(delete_negotiation_exports, {
  deleteNegotiationRoute: () => deleteNegotiationRoute
});
module.exports = __toCommonJS(delete_negotiation_exports);
...
// src/routes/delete-negotiation.ts
var deleteNegotiationRoute = async (app) => {
  app.delete(
    "/negotiation/:id",
    {
