...
var get_negotiation_by_id_exports = {};
__export(get_negotiation_by_id_exports, {
  getNegotiationByIdRoute: () => getNegotiationByIdRoute
});
module.exports = __toCommonJS(get_negotiation_by_id_exports);
...
// src/routes/get-negotiation-by-id.ts
var getNegotiationByIdRoute = async (app) => {
  app.get(
    "/negotiation/:id",
    {
