...
__export(update_portal_controll_exports, {
  updatePortalControllRoute: () => updatePortalControllRoute
});
...
// src/routes/update-portal-controll.ts
var updatePortalControllRoute = async (app) => {
  app.put(
    "/portalcontrolls/:id",
    {
      ...
      schema: {
        ...
        body: import_zod2.z.object({
          enterprise: import_zod2.z.string().nullable().optional(),
          product: import_zod2.z.string().nullable().optional(),
          percentageHonorary: import_zod2.z.number().nullable().optional(),
          compensation: import_zod2.z.number().nullable().optional(),
          honorary: import_zod2.z.number().nullable().optional(),
          tax: import_zod2.z.number().nullable().optional(),
          tj: import_zod2.z.number().nullable().optional(),
          value: import_zod2.z.number().nullable().optional(),
          situation: import_zod2.z.string().nullable().optional(),
          partnerId: import_zod2.z.string().optional()
        }),
        response: {
          200: import_zod2.z.object({ id: import_zod2.z.string() }),
