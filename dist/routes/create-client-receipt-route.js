...
var create_client_receipt_route_exports = {};
__export(create_client_receipt_route_exports, {
  createClientReceiptRoute: () => createClientReceiptRoute
});
module.exports = __toCommonJS(create_client_receipt_route_exports);
...
// src/routes/create-client-receipt-route.ts
var createClientReceiptRoute = async (app) => {
  app.post(
    "/client-receipt",
    {
