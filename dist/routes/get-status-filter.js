...
var get_status_filter_exports = {};
__export(get_status_filter_exports, {
  getContractStatusCountByFilterRoute: () => getContractStatusCountByFilterRoute
});
module.exports = __toCommonJS(get_status_filter_exports);
...
// src/routes/get-status-filter.ts
var getContractStatusCountByFilterRoute = async (app) => {
  app.post(
...
0 && (module.exports = {
  getContractStatusCountByFilterRoute
});
