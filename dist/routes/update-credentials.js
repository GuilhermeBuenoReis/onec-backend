...
var update_credentials_exports = {};
__export(update_credentials_exports, {
  updateCredentialRoute: () => updateCredentialRoute
});
module.exports = __toCommonJS(update_credentials_exports);
...
// src/routes/update-credentials.ts
var updateCredentialRoute = async (app) => {
  app.put(
    "/credential/:id",
    {
