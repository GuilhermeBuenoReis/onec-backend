...
var create_data_negotiation_exports = {};
__export(create_data_negotiation_exports, {
  createDataNegotiationRoute: () => createDataNegotiationRoute
});
module.exports = __toCommonJS(create_data_negotiation_exports);
...
// src/routes/create-data-negotiation.ts
var createDataNegotiationRoute = async (app) => {
  app.post(
    "/negotiation",
    {
